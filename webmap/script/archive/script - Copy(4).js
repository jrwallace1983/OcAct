	  ...
	  arrayUtils, BasemapGallery, arcgisUtils,webMercatorUtils, on, Query, QueryTask, SimpleMarkerSymbol, Color, SpatialReference, dom, parser) {
	    ...
	    var hydrant_string = "https://sampleserver6.arcgisonline.com/arcgis/rest/services/Water_Network/FeatureServer/8"
		var sysvalve_string = "https://sampleserver6.arcgisonline.com/arcgis/rest/services/Water_Network/FeatureServer/15"
		//This is the feature layer object
		var hydrantLayer = new FeatureLayer(hydrant_string,{
			mode: FeatureLayer.MODE_SNAPSHOT,
            infoTemplate: template,
            outFields: ["*"]
		});
		var sysvalveLayer = new FeatureLayer(sysvalve_string,{
			mode: FeatureLayer.MODE_SNAPSHOT,
            infoTemplate: template,
            outFields: ["*"]
		});
